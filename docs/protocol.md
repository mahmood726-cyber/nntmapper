        # Nntmapper: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/nntmapper.git

        ## Objective

        NNTMapper is a meta-analytic number-needed-to-treat (NNT) calculator with decision curve analysis, translating pooled effect sizes into clinically actionable absolute risk metrics.
        ...
        - Code: https://github.com/mahmood726-cyber/nntmapper.git
        - Dashboard: https://mahmood726-cyber.github.io/nntmapper/
